...
import { useGetAllLogsByParcelIdQuery } from '@/slice/fetch';
import Loading from '../Atom/Loading';

type DisplayParcelLog = {
  parcelId: number;
};

const Display_ParcelLogs_Popup: FC<DisplayParcelLog> = ({ parcelId }) => {
  const {
    data: parcelLogs,
    isLoading: parcelIsLoading,
    isError: parcelIsError,
  } = useGetAllLogsByParcelIdQuery({ parcelId });
...
export default Display_ParcelLogs_Popup;
