...
import { useGetAllLogsByNurseryIdQuery } from '@/slice/fetch';
import Loading from '../Atom/Loading';

type DisplayNurseryLog = {
  nurseryId: number;
};

const Display_NurseryLogs_Popup: FC<DisplayNurseryLog> = ({ nurseryId }) => {
  const {
    data: nurseryLogs,
    isLoading: nurseryIsLoading,
    isError: nurseryIsError,
  } = useGetAllLogsByNurseryIdQuery({ nurseryId });
...
export default Display_NurseryLogs_Popup;
